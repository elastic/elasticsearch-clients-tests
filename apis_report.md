...
| Endpoint name | Available | Tested | Tested in ES |
| :------------ | :-------: | :----: | :----------: |
| async_search.delete | 🟢 | [✅](./tests/async_search/10_basic.yml#L53)</li></ul> | 👍
| async_search.get | 🟢 | [✅](./tests/async_search/10_basic.yml#L43)</li></ul> | 👍
| async_search.status | 🟢 | [✅](./tests/async_search/10_basic.yml#L48)</li></ul> | 👍
| async_search.submit | 🟢 | [✅](./tests/async_search/10_basic.yml#L35)</li></ul> | 👍
...
| connector.update_api_key_id | 🟢 | [✅](./tests/entsearch/50_connector_updates.yml#L240)</li></ul> | 👍
...
| connector.update_index_name | 🟢 | [✅](./tests/entsearch/50_connector_updates.yml#L136)</li></ul> | 👍
| connector.update_name | 🟢 | [✅](./tests/entsearch/50_connector_updates.yml#L24)</li></ul> | 👍
| connector.update_native | 🟢 | [✅](./tests/entsearch/50_connector_updates.yml#L158)</li></ul> | 👍
| connector.update_pipeline | 🟢 | [✅](./tests/entsearch/50_connector_updates.yml#L171)</li></ul> | 👍
| connector.update_scheduling | 🟢 | [✅](./tests/entsearch/50_connector_updates.yml#L190)</li></ul> | 👍
| connector.update_service_type | 🟢 | [✅](./tests/entsearch/50_connector_updates.yml#L228)</li></ul> | 👍
| connector.update_status | 🟢 | [✅](./tests/entsearch/50_connector_updates.yml#L216)</li></ul> | 👍
| count | 🟢 | [✅](./tests/bulk/10_basic.yml#L24)</li></ul> | 👍
...
| ilm.delete_lifecycle | 🟢 | [✅](./tests/ilm/10_basic.yml#L88)</li></ul> | 🙌
...
| ilm.remove_policy | 🟢 | [✅](./tests/ilm/10_basic.yml#L83)</li></ul> | 👍
| ilm.retry | 🟢 | ❌ | 👎
| ilm.start | 🟢 | [✅](./tests/ilm/10_basic.yml#L75)</li></ul> | 🙌
| ilm.stop | 🟢 | [✅](./tests/ilm/10_basic.yml#L79)</li></ul> | 🙌
...
| indices.create_from | 🟢 | ❌ | 👍
| indices.data_streams_stats | 🟢 | [✅](./tests/indices/data_streams.yml#L36)</li></ul> | 👍
...
| indices.simulate_index_template | 🟢 | [✅](./tests/indices/simulate_template_stack.yml#L37)</li></ul> | 👍
...
| ml.get_trained_models_stats | 🟢 | [✅](./tests/machine_learning/20_trained_model.yml#L47)</li></ul> | 👍
...
| ml.put_trained_model_definition_part | 🟢 | [✅](./tests/machine_learning/20_trained_model.yml#L36)</li></ul> | 👍
| ml.put_trained_model_vocabulary | 🟢 | [✅](./tests/machine_learning/20_trained_model.yml#L30)</li></ul> | 👍
...
| ml.start_trained_model_deployment | 🟢 | [✅](./tests/machine_learning/20_trained_model.yml#L52)</li></ul> | 👍
...
| ml.stop_trained_model_deployment | 🟢 | [✅](./tests/machine_learning/20_trained_model.yml#L68)</li></ul> | 👍
...
| ml.update_trained_model_deployment | 🟢 | [✅](./tests/machine_learning/20_trained_model.yml#L59)</li></ul> | 👍
...
| security.activate_user_profile | 🟢 | [✅](./tests/security/50_user_profile.yml#L41)</li></ul> | 👍
...
| security.clear_cached_service_tokens | 🟢 | [✅](./tests/security/90_service_accounts.yml#L40)</li></ul> | 👍
...
| security.create_service_token | 🟢 | [✅](./tests/security/90_service_accounts.yml#L25)</li></ul> | 👍
...
| security.disable_user | 🟢 | [✅](./tests/security/50_user_profile.yml#L179)</li></ul> | 👍
| security.disable_user_profile | 🟢 | [✅](./tests/security/50_user_profile.yml#L104)</li></ul> | 👍
| security.enable_user | 🟢 | [✅](./tests/security/50_user_profile.yml#L191)</li></ul> | 👍
| security.enable_user_profile | 🟢 | [✅](./tests/security/50_user_profile.yml#L115)</li></ul> | 👍
...
| security.get_user_profile | 🟢 | [✅](./tests/security/50_user_profile.yml#L75)</li></ul> | 👍
...
| security.has_privileges_user_profile | 🟢 | [✅](./tests/security/50_user_profile.yml#L163)</li></ul> | 👍
...
| security.query_user | 🟢 | [✅](./tests/security/50_user_profile.yml#L202)</li></ul> | 👍
...
| security.suggest_user_profiles | 🟢 | [✅](./tests/security/50_user_profile.yml#L145)</li></ul> | 👍
...
| security.update_user_profile_data | 🟢 | [✅](./tests/security/50_user_profile.yml#L125)</li></ul> | 👍
| simulate.ingest | 🟢 | ❌ | 👍
...
| tasks.cancel | 🟢 | [✅](./tests/tasks.yml#L16)</li></ul> | 👍
| tasks.get | 🟢 | [✅](./tests/tasks.yml#L8)</li></ul> | 👍
| tasks.list | 🟢 | [✅](./tests/machine_learning/set_upgrade_mode.yml#L122)</li></ul> | 👍
...
| update_by_query | 🟢 | [✅](./tests/update_by_query/10_basic.yml#L21)</li></ul> | 👍
